...
// TODO(bosnia): SRC указывает на плейсхолдер; заменить на реальный hero-кадр
// Боснии перед генерацией og-default.jpg к запуску.
const SRC = 'public/images/placeholder-cover.svg';
const OUT = 'public/og-default.jpg';
const TITLE = 'Bosnia and Herzegovina Guidebook';
const SUBTITLE = 'A vetted travel guide to Bosnia and Herzegovina';
