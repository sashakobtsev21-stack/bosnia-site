// Финальный QA-оркестратор Bosnia and Herzegovina Guidebook (ROADMAP #21).
...
const ORIGIN = 'https://bosniaguidebook.com';
const TITLE_SUFFIX = ' — Bosnia and Herzegovina Guidebook';
const DIST = 'dist';
